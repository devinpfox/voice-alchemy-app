...
function invertBackground(isInvert) {
  ...
  console.log("Detected Frequency:", frequencyValue);

  // Add a margin of ±10Hz to the frequency for sensitivity
  const lowerFrequencyBound = frequencyValue - 5;
  const upperFrequencyBound = frequencyValue + 5;
  console.log("Lower Bound:", lowerFrequencyBound);
  console.log("Upper Bound:", upperFrequencyBound);


  if (isInvert && isFrequencyInRange(lowerFrequencyBound, upperFrequencyBound)) {
